/*
The function dfs flattens the tree in such a way that queries
on subtrees are transformed into queries on subarrays. Thus we
have to answer queries of the form "how many colors occur at
